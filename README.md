# gbuckingham89/eloquent-uuid v1

**If you are using Laravel 5.6+, please use v2 of this package [newer version available](https://github.com/gbuckingham89/eloquent-uuid).**
